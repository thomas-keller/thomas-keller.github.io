...
I made a small [github repo](https://github.com/thomas-keller/tweet-conf) for the associated R scripts so you can just pull the R scripts instead of copying and pasting, or you can do that as well if you like.
